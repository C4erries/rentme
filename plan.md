...
- [ ] A) ML: добавить `way=transit` (общественный транспорт) помимо `walk`/`car`
...
- [ ] B) Просмотр объявления: модалка/окно карточки не помещается в экран
...
- [ ] C) Каталог: пометка “Ваше объявление” для хоста
...
- [ ] D) ML: “слегка адекватизировать” влияние ремонта на цену
...
- [ ] E) Бронирование long_term: корректная цена и UX дат
...
- [ ] F) Подтверждение брони хостом: UI/навигация
...
- [ ] G) “Мои бронирования”: кнопка перейти в чат для каждой брони
